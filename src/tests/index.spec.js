...
describe('Spotidy API Wrapper', () => {
  ...
  describe('Albums', () => {
    ...
    it('should retrieve album info by ID', (done) => {
      ...
      const expectedHeader = {"headers": {"Accept": "application/json", "Authorization": "Bearer BQCckdNXOiGk1EAlNFiGoonvria0lXkxkrtiWJ0VrlsN16MNAnV8qrgzn20XHA4J8hZ2l4J7uTA6ITQEJA1HYyvEesD1ua", "Content-Type": "application/json"}};
